...
VOLTAGE_BUILD_DATE_UTC := $(shell date -d '$(VOLTAGE_DATE_YEAR)-$(VOLTAGE_DATE_MONTH)-$(VOLTAGE_DATE_DAY) $(VOLTAGE_DATE_HOUR):$(VOLTAGE_DATE_MINUTE) UTC' +%s)
...
VOLTAGE_FINGERPRINT := VoltageOS/$(VOLTAGE_MOD_VERSION)/$(TARGET_PRODUCT_SHORT)/$(shell date -u +%H%M)
