...
ALARM_PATH := vendor/voltage/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/voltage/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/voltage/prebuilt/common/media/audio/ringtones
