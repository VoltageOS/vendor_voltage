...
SOONG_CONFIG_voltageGlobalVars_has_legacy_camera_hal1 := $(TARGET_HAS_LEGACY_CAMERA_HAL1)
SOONG_CONFIG_voltageGlobalVars_has_memfd_backport := $(TARGET_HAS_MEMFD_BACKPORT)
...
SOONG_CONFIG_voltageQcomVars_supports_hw_fde := $(TARGET_HW_DISK_ENCRYPTION)
SOONG_CONFIG_voltageQcomVars_supports_hw_fde_perf := $(TARGET_HW_DISK_ENCRYPTION_PERF)
...
SOONG_CONFIG_voltageGlobalVars_target_surfaceflinger_fod_lib := $(TARGET_SURFACEFLINGER_FOD_LIB)
